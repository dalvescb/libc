...
pub const BIOCFLUSH: c_int = 536887912;
pub const BIOCPROMISC: c_int = 536887913;
pub const BIOCGDLT: c_int = 1074020970;
pub const BIOCSRTIMEOUT: c_int = -2146418067;
pub const BIOCGSTATS: c_int = 1074283119;
pub const BIOCIMMEDIATE: c_int = -2147204496;
pub const BIOCVERSION: c_int = 1074020977;
pub const BIOCSDEVNO: c_int = 536887922;
pub const BIOCGETIF: c_int = 1075855979;
pub const BIOCSETIF: c_int = -2145369492;
...
pub const IOC_VOID: c_int = 536870912;
pub const IOC_OUT: c_int = 1073741824;
pub const IOC_IN: c_int = -2147483648;
...
pub const TIOCGETD: c_int = 1074033664;
pub const TIOCSETD: c_int = -2147191807;
pub const TIOCHPCL: c_int = 536900610;
pub const TIOCMODG: c_int = 1074033667;
pub const TIOCMODS: c_int = -2147191804;
...
pub const TIOCGETP: c_int = 1074164744;
pub const TIOCSETP: c_int = -2147060727;
pub const TIOCSETN: c_int = -2147060726;
pub const TIOCEXCL: c_int = 536900621;
pub const TIOCNXCL: c_int = 536900622;
pub const TIOCFLUSH: c_int = -2147191792;
pub const TIOCSETC: c_int = -2147060719;
pub const TIOCGETC: c_int = 1074164754;
...
pub const TIOCLBIS: c_int = -2147191681;
pub const TIOCLBIC: c_int = -2147191682;
pub const TIOCLSET: c_int = -2147191683;
pub const TIOCLGET: c_int = 1074033788;
pub const TIOCSBRK: c_int = 536900731;
pub const TIOCCBRK: c_int = 536900730;
pub const TIOCSDTR: c_int = 536900729;
pub const TIOCCDTR: c_int = 536900728;
pub const TIOCSLTC: c_int = -2147060619;
pub const TIOCGLTC: c_int = 1074164852;
pub const TIOCOUTQ: c_int = 1074033779;
pub const TIOCNOTTY: c_int = 536900721;
pub const TIOCSTOP: c_int = 536900719;
pub const TIOCSTART: c_int = 536900718;
pub const TIOCGPGRP: c_int = 1074033783;
pub const TIOCSPGRP: c_int = -2147191690;
pub const TIOCGSID: c_int = 1074033736;
